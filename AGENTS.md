...
**Three staff access levels, and no more: CEO, Manager, Staff.** One code per level. Finer distinctions are permissions on a role, edited by the CEO at runtime — never a new tier and never a per-account override.
